...
hard_chart_no_doubles = {
    5: {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    6: {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    7: {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    8: {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    9: {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    10: {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    11: {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    12: {"2": "Hit", "3": "Hit", "4": "Stand", "5": "Stand", "6": "Stand", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    13: {"2": "Stand", "3": "Stand", "4": "Stand", "5": "Stand", "6": "Stand", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    14: {"2": "Stand", "3": "Stand", "4": "Stand", "5": "Stand", "6": "Stand", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    15: {"2": "Stand", "3": "Stand", "4": "Stand", "5": "Stand", "6": "Stand", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
...
soft_chart_no_doubles = {
    "A, 2": {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    "A, 3": {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    "A, 4": {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    "A, 5": {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    "A, 6": {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
    ...
    "5, A": {"2": "Hit", "3": "Hit", "4": "Hit", "5": "Hit", "6": "Hit", "7": "Hit", "8": "Hit", "9": "Hit", "10": "Hit", "A": "Hit"},
...
def sort_hand(hand):
    ...
    return order.index(hand)

def make_move(hand, num_hands, dealer_upcard):
    sorted_hand = sorted(hand, key=sort_hand)
    num_cards = len(sorted_hand)
    decision = ""

    if num_cards == 2 and sorted_hand[0] == sorted_hand[1] and num_hands < 4:
        parsed_hand = sorted_hand[0] + ", " + sorted_hand[1]
        decision = pairs_chart[parsed_hand][dealer_upcard]
    elif sorted_hand[0] == 'A' and num_cards == 2:
        parsed_hand = sorted_hand[0] + ", " + sorted_hand[1]
        decision = soft_chart[parsed_hand][dealer_upcard]
    elif sorted_hand[0] == 'A' and num_cards > 2:
        non_ace_value = 0
        num_aces = 0
        for card in sorted_hand:
            if card != 'A':
                ...
                num_aces += 1
        hard_value = non_ace_value + ((num_aces - 1) * 1)
        parsed_hand = sorted_hand[0] + ", " + str(hard_value)
    elif num_cards == 2:
        parsed_hand = int(sorted_hand[0]) + int(sorted_hand[1])
        decision = hard_chart[parsed_hand][dealer_upcard]
    elif num_cards > 2:
        parsed_hand = 0
        for card in sorted_hand:
            parsed_hand += int(card)
        decision = hard_chart_no_doubles[parsed_hand][dealer_upcard]
